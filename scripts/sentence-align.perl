# This is a vanilla implementation of Church and Gale sentence alignment by P. Koehn
...
open my $f1, "<$l1" or die "Could not open file ".$l1;
my @TXT1native = readline($f1);
close $f1;
open my $f2, "<$l2" or die "Could not open file ".$l2;
my @TXT2native = readline($f2);
close $f2;
